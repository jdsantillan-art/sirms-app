...
def direct_report(request):
    ...
    try:
        ...
        teacher_assignments = TeacherAssignment.objects.select_related('curriculum').all()
        
        # Build section structure from database with teacher info
        section_structure = {}
        teacher_lookup = {}  # For quick teacher lookup: {curriculum_grade_section_track: teacher_name}
        ...
        context = {
            ...
            'teacher_assignments': teacher_assignments,  # All teacher assignments for dropdowns
