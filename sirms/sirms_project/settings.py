...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-sirms-school-incident-reporting-management-system')
...
ROOT_URLCONF = 'sirms_project.urls'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'incidents.context_processors.notifications_context',
            ],
        },
    },
]

WSGI_APPLICATION = 'sirms_project.wsgi.application'

# Database Configuration
# Use DATABASE_URL if available (Render), otherwise fall back to manual config
...
# Use ManifestStaticFilesStorage to avoid compression issues
...
AUTHENTICATION_BACKENDS = [
    'incidents.google_auth.GoogleOAuthBackend',
